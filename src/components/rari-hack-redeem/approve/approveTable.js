    ...
    <div>
      ...
      {fuseState && Object.keys(fuseState).length ? (
        <div className="fuse-openborrows">
          ...
          {Object.keys(fuseState).map((cTokenAddress) => (
            <div>
          ...
          <div>
            You can Approve ctokens, but if you enter amounts too high in the Claim and redeem section, your transaction
            will fail.
          </div>
        </div>
      ) : null}
